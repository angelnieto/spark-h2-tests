...
Scenario: Modification and creation of students
    Given an "update" operation in table "student" we set the value "Ally" in the field "first_name" for the student with field "id" with value 1
    And an "insert" operation in table "student" to insert a new student with the value "Nelle" in the field "first_name" and the value "Porter" in the field "last_name"
