...
class StepDefinitions extends ScalaDsl with EN {
  ...
  Given("""an {string} operation in table {string} to insert a new lawyer with the value {string} in the field {string} and the value {string} in the field {string}""") { 
  ...
  And("""an {string} operation in table {string} we set the value {string} in the field {string} for the lawyer with field {string} with value {int}""") { 
  ...
  Then("""the lawyer in the table {string} with field {string} with value {int} changed the field {string} to the value {string}""") {
  ...
  Then("""the lawyer in the table {string} with field {string} with value {string} has the value {string} in the field {string}""") { 
